...
import com.portfolio.jgl.Dto.dtoEducacion;
import com.portfolio.jgl.Entity.Educacion;
import com.portfolio.jgl.Security.Controller.Mensaje;
import com.portfolio.jgl.Service.Seducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> delete (@PathVariable("id") int id){
       ...
       return new ResponseEntity(new Mensaje("Educaciin eliminada"),HttpStatus.OK);
